                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="qualification_subtitle"
                                            value="{{ $page_data->qualification_subtitle }}">
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label">Qualification Title</label>
                                        <input type="text" class="form-control" name="qualification_title"
                                            value="{{ $page_data->qualification_title }}">
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label">Education Title</label>
                                        <input type="text" class="form-control" name="education_title"
                                            value="{{ $page_data->education_title }}">
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label">Experience Title</label>
                                        <input type="text" class="form-control" name="experience_title"
                                            value="{{ $page_data->experience_title }}">
                                    </div>
